...
var _Sources = (() => {
  ...
  var CuuTruyen_exports = {};
  __export(CuuTruyen_exports, {
    CuuTruyen: () => CuuTruyen,
    CuuTruyenInfo: () => CuuTruyenInfo
  });
  var import_types2 = __toESM(require_lib());

  // src/CuuTruyen/CuuTruyenParser.ts
  var import_types = __toESM(require_lib());

  // src/CuuTruyen/CuuTruyenHelper.ts
  var CuuTruyenGenresClass = class {
    constructor() {
      this.Genres = [
  ...
  var CuuTruyenGenres = new CuuTruyenGenresClass();
  var CuuTruyenLanguagesClass = class {
    constructor() {
      this.Languages = [
        {
          name: "Vietnamese",
    ...
    getLangIcon(code) {
      return this.Languages.find((Language) => Language.code === code)?.lang ?? "\u{1F310}";
    }
    getDefault() {
      return this.Languages.filter((Language) => Language.default).map((Language) => Language.code);
    }
  };
  var CuuTruyenLanguages = new CuuTruyenLanguagesClass();
  ...
  var parseMangaDetails = ($, mangaId) => {
    ...
    const author = $('.detail-info span:contains("T\xE1c gi\u1EA3")').next().text().trim();
    ...
    const statusText = $('.detail-info span:contains("T\xECnh tr\u1EA1ng")').next().text().trim().toLowerCase();
    let status = "Ongoing";
    if (statusText.includes("ho\xE0n th\xE0nh")) status = "Completed";
  ...
  var parseChapterList = ($, mangaId) => {
    ...
    $(".list-chapters li").each((_, el) => {
      ...
      const date = timeText ? new Date(timeText) : /* @__PURE__ */ new Date();
  ...
  // src/CuuTruyen/CuuTruyen.ts
  var CUUTRUYEN_DOMAIN = "https://cuutruyen.net";
  var CuuTruyenInfo = {
    version: "1.0.0",
    name: "CuuTruyen",
    icon: "cuutruyen.png",
...
Please go to the homepage of <${CuuTruyenInfo.name}> and press the cloud icon.`);
  ...
  return __toCommonJS(CuuTruyen_exports);
})();
