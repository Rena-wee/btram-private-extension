...
class CuuTruyen {
    ...
    async getMangaDetails(mangaId) {
        ...
        return (0, CuuTruyenParser_1.parseMangaDetails)($, mangaId);
    }
    async getChapters(mangaId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, CuuTruyenParser_1.parseChapterList)($, mangaId);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, CuuTruyenParser_1.parseChapterDetails)($, mangaId, chapterId);
    }
    async getHomePageSections(sectionCallback) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        (0, CuuTruyenParser_1.parseHomeSections)($, sectionCallback);
    }
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        const manga = (0, CuuTruyenParser_1.parseViewMore)($);
        metadata = !(0, CuuTruyenParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
    ...
    async getSearchResults(query, metadata) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        const manga = (0, CuuTruyenParser_1.parseSearch)($);
        metadata = !(0, CuuTruyenParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
        return App.createPagedResults({
            results: manga,
            metadata
    ...
    async getSearchTags() {
        return (0, CuuTruyenParser_1.parseTags)();
    }
    async getThumbnailUrl(mangaId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, CuuTruyenParser_1.parseThumbnailUrl)($);
    }
    CloudFlareError(status) {
        if (status == 503 || status == 403) {
            throw new Error(`CLOUDFLARE BYPASS ERROR:\nPlease go to the homepage of <${exports.CuuTruyenInfo.name}> and press the cloud icon.`);
        }
    }
...
exports.default = CuuTruyen;

},{"./CuuTruyenParser":72,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.CuuTruyenLanguages = exports.CuuTruyenGenres = void 0;
...
exports.CuuTruyenGenres = new CuuTruyenGenresClass();
...
exports.CuuTruyenLanguages = new CuuTruyenLanguagesClass();

},{}],72:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.isLastPage = exports.parseThumbnailUrl = exports.parseTags = exports.parseSearch = exports.parseViewMore = exports.parseHomeSections = exports.parseChapterDetails = exports.parseChapterList = exports.parseMangaDetails = void 0;
const types_1 = require("@paperback/types");
const CuuTruyenHelper_1 = require("./CuuTruyenHelper");
...
const parseMangaDetails = ($, mangaId) => {
    ...
    $('.detail-info a.genre-item').each((_, el) => {
        ...
        const id = encodeURI(CuuTruyenHelper_1.CuuTruyenGenres.getParam(label) ?? label);
        if (label && id)
    ...
    if (statusText.includes('hoàn thành'))
        status = 'Completed';
    if (statusText.includes('tạm ngưng'))
        status = 'Hiatus';
    const tagSections = [App.createTagSection({ id: '0', label: 'genres', tags: arrayTags.map(App.createTag) })];
    return App.createSourceManga({
        id: mangaId,
        mangaInfo: App.createMangaInfo({
            titles,
            image: (0, exports.parseThumbnailUrl)($),
            author,
            artist,
            desc: description,
            status,
 ...
 */
const parseTags = () => {
    const tags = CuuTruyenHelper_1.CuuTruyenGenres.getGenresList().map(label => {
        const id = encodeURI(CuuTruyenHelper_1.CuuTruyenGenres.getParam(label) ?? label);
...
},{"./CuuTruyenHelper":71,"@paperback/types":61,"entities":69}]},{},[70])(70)
});
