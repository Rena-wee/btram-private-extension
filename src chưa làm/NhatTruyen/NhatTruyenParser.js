...
const parseMangaList = async (response, source, thumbnailSelector) => {
    ...
    for (const manga of mangaArray) {
        ...
        const image = coverFileName
            ? `${source.COVER_BASE_URL}/${mangaId}/${coverFileName}${NhatTruyenHelper_1.MDImageQuality.getEnding(await thumbnailSelector(source.stateManager))}`
...
//# sourceMappingURL=NhatTruyenParser.js.map