...
async function getLanguages(stateManager) {
    return (await stateManager.retrieve('languages') ?? NhatTruyenHelper_1.MDLanguages.getDefault());
}
exports.getLanguages = getLanguages;
async function getRatings(stateManager) {
    return (await stateManager.retrieve('ratings') ?? NhatTruyenHelper_1.MDRatings.getDefault());
}
...
async function getHomepageThumbnail(stateManager) {
    return (await stateManager.retrieve('homepage_thumbnail') ?? [NhatTruyenHelper_1.MDImageQuality.getDefault('homepage')]);
}
exports.getHomepageThumbnail = getHomepageThumbnail;
async function getSearchThumbnail(stateManager) {
    return (await stateManager.retrieve('search_thumbnail') ?? [NhatTruyenHelper_1.MDImageQuality.getDefault('search')]);
}
exports.getSearchThumbnail = getSearchThumbnail;
async function getMangaThumbnail(stateManager) {
    return (await stateManager.retrieve('manga_thumbnail') ?? [NhatTruyenHelper_1.MDImageQuality.getDefault('manga')]);
}
                    ...
                    rows: async () => {
                        ...
                        return await [
                            App.createDUISelect({
                                id: 'languages',
                                label: 'Languages',
                                options: NhatTruyenHelper_1.MDLanguages.getMDCodeList(),
                                labelResolver: async (option) => NhatTruyenHelper_1.MDLanguages.getName(option),
                            ...
                            App.createDUISelect({
                                ...
                                options: NhatTruyenHelper_1.MDRatings.getEnumList(),
                                labelResolver: async (option) => NhatTruyenHelper_1.MDRatings.getName(option),
                                value: App.createDUIBinding({
                    ...
                    rows: async () => {
                        ...
                        return await [
                            App.createDUISelect({
                                ...
                                options: NhatTruyenHelper_1.MDImageQuality.getEnumList(),
                                labelResolver: async (option) => NhatTruyenHelper_1.MDImageQuality.getName(option),
                                value: App.createDUIBinding({
...
//# sourceMappingURL=NhatTruyenSettings.js.map